...
func load_game()->void:
	max_coins = config.get_value("level1", "max_coins")
	coins = config.get_value("level1", "coins")
	last_time=float(config.get_value("level1","last_time"))
	best_time=float(config.get_value("level1","best_time"))
	completed=config.get_value("level1","completed")
